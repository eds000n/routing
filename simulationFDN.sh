...
function_exec_case1 ()
{
	...
	do
		...
		do
			...
			#do
				if [ $1 == "GA" ]; then
					cmd="$basecmd -gen $n ${nodeType} $model -batch -overwrite Event/NumEvents=$ne -overwrite Population=$population -overwrite Generations=$generations -overwrite Objective=1 -overwrite fixedSeed=$seed -overwrite dimX=$dimx -overwrite dimY=$dimy -overwrite Event/DataRate=$datarate -overwrite Event/Xposition1=${x[1]} -overwrite Event/Yposition1=${y[1]} -overwrite Event/Xposition2=${x[2]} -overwrite Event/Yposition2=${y[2]} -overwrite Event/Xposition3=${x[3]} -overwrite Event/Yposition3=${y[3]} -overwrite Event/Xposition4=${x[4]} -overwrite Event/Yposition4=${y[4]} -overwrite Event/Xposition5=${x[5]} -overwrite Event/Yposition5=${y[5]} -overwrite Event/Xposition6=${x[6]} -overwrite Event/Yposition6=${y[6]} > ${n}-${ne}-${seed}-${project}-${datarate}.1.out"
					cmd="$basecmd -gen $n ${nodeType} $model -batch -overwrite Event/NumEvents=$ne -overwrite Population=$population -overwrite Generations=$generations -overwrite Objective=2 -overwrite fixedSeed=$seed -overwrite dimX=$dimx -overwrite dimY=$dimy -overwrite Event/DataRate=$datarate -overwrite Event/Xposition1=${x[1]} -overwrite Event/Yposition1=${y[1]} -overwrite Event/Xposition2=${x[2]} -overwrite Event/Yposition2=${y[2]} -overwrite Event/Xposition3=${x[3]} -overwrite Event/Yposition3=${y[3]} -overwrite Event/Xposition4=${x[4]} -overwrite Event/Yposition4=${y[4]} -overwrite Event/Xposition5=${x[5]} -overwrite Event/Yposition5=${y[5]} -overwrite Event/Xposition6=${x[6]} -overwrite Event/Yposition6=${y[6]} > ${n}-${ne}-${seed}-${project}-${datarate}.2.out"
				else
					cmd="$basecmd -gen $n ${nodeType} $model -batch -overwrite Event/NumEvents=$ne -overwrite fixedSeed=$seed -overwrite dimX=$dimx -overwrite dimY=$dimy -overwrite Event/DataRate=$datarate -overwrite Event/Xposition1=${x[1]} -overwrite Event/Yposition1=${y[1]} -overwrite Event/Xposition2=${x[2]} -overwrite Event/Yposition2=${y[2]} -overwrite Event/Xposition3=${x[3]} -overwrite Event/Yposition3=${y[3]} -overwrite Event/Xposition4=${x[4]} -overwrite Event/Yposition4=${y[4]} -overwrite Event/Xposition5=${x[5]} -overwrite Event/Yposition5=${y[5]} -overwrite Event/Xposition6=${x[6]} -overwrite Event/Yposition6=${y[6]} > ${n}-${ne}-${seed}-${project}-${datarate}.out"
				fi
				echo $cmd >> .cmdfile
			#done
		done

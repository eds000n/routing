package projects.DAARPMSWIM.models.reliabilityModels;

import projects.DAARPMSWIM.nodes.messages.DAARPMSWIM_DataMessage;
...
public class TaxadePerda extends ReliabilityModel {
	...
	public boolean reachesDestination(Packet p){ 
		if(p.message instanceof DAARPMSWIM_DataMessage){

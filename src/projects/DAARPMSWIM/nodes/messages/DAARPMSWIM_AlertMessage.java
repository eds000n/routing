...
public class DAARPMSWIM_AlertMessage extends Message {
	private int myID;
	...
	public DAARPMSWIM_AlertMessage(int myID, int hopToSink,int eventID, int hoptoevent,int hopstocoordinator, int senderid, int candidateid, int owneridhoptoevent, int owneridhopstosink) {
		this.myID = myID;
		HopToSink = hopToSink;

...
public class DAARPMSWIM_CHIntentMessage extends Message {
...
private int HoptoEvent;
	...
	public DAARPMSWIM_CHIntentMessage(int senderID, int chcandidate, int hopToSInk, int hoptoevent, int hopstocoordinator) {

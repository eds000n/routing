...
/**
 * ERADataMessage is the kind of message used when a node detects an event and has to send the 
 ...
 *
 */
public class ERADataMessage extends Message {
	private int dest;
	private int sender;
	...
	public ERADataMessage(int sender, int dest, String payload, int hoptosink, int aggpacket, double energy, int eventnum) {
		this.dest = dest;
		this.sender = sender;
	...
	public Message clone() {
		...
		return new ERADataMessage(sender,dest,payload,HopToSink,AggPacket,Energy,EventNum);
	}

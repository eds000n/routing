...
public class DDAARP_AnnouceCHMessage extends Message {
	...
	public DDAARP_AnnouceCHMessage(int hopToEvent, int sender, int eventnum, int hoptosink, int nexthopsender, double energy) {
